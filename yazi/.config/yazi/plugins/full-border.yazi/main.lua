...
local function setup(_, opts)
    -- Enforces the rounded border type for the MD3 card/pill aesthetic
    ...
    Tab.build = function(self, ...)
        ...
        self._base = ya.list_merge(self._base or {}, {
            ...
            -- Replaced sharp "┬" and "┴" T-junctions with continuous horizontal lines "─"
            -- This creates an uninterrupted outer rounded border (MD3 surface look)
            bar("─", c[2].x, c[1].y),
